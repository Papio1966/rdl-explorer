...
const routes = ["/", "/rdls", "/search?q=pump&source=all",
  "/intelligence", "/governance", "/hierarchy", "/extensions", "/publication", "/distribution", "/integration", "/impact", "/migration", "/control-tower", "/work-queue", "/ai-intelligence", "/documents", "/cis", "/assistant", "/about", "/help"];
