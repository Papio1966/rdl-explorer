...
const navigation = [
  ...
  { label: "Intelligence", items: [{ label: "Cross-RDL Intelligence", to: "/intelligence", icon: GitBranch }, { label: "Mapping Governance", to: "/governance", icon: ShieldCheck }, { label: "AI Assistant", to: "/assistant", icon: Sparkles }] },
